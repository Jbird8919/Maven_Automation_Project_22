...
public class TestNG_Example {
    ...
    @Test(dependsOnMethods = "SearchForKeyword") /* dependsOnMethods used when following @Test is dependent on previous @Test method. Then If the first test fails,
    the dependent test will get skipped */
    //@Test(priority = 2) is used for order to be tested for @Test
